...
:sparkles: 입대 시 병사들의 경우 샘플 피복 착용 후 희망 치수를 분배 또는 본인이 입던 치수나 신체 측정 치수를 바탕으로
  * 교관 경험에 의해 피복류가 추천(지급)됨에 따라
  * 피복 착용 후 **사이즈가 맞지 않는 불편 호소와 교환이 빈번하게 발생**하고,

:sparkles: 변화된 입대 장병들의 **신체 치수에 유연하게 적용 가능한 치수체계 미정립**으로
  * 입대 장병들의 희망치수 사전 확보 부족 및 불출 지연 발생과 특정치수의 재고 누적 현상이 발생함에 따라 

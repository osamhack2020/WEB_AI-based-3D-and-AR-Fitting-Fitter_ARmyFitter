...
public class buttonFunc : MonoBehaviour
{
    ...
    public void OnClickResult()
    {
        ...
        if (0.066f >= distanceTo){
            value1.gameObject.GetComponent<Text>().text = "SS";}
        if (0.066f < distanceTo && 0.074f >= distanceTo)
        {value1.gameObject.GetComponent<Text>().text = "AA";}
        else if(0.074f < distanceTo && 0.082f >= distanceTo)
        {value1.gameObject.GetComponent<Text>().text = "BB";}
        else if (0.082f < distanceTo && 0.090f >= distanceTo)
        {value1.gameObject.GetComponent<Text>().text = "CC";}
        else if (0.090f < distanceTo)
        {value1.gameObject.GetComponent<Text>().text = "DD";}
        exp.SetActive(true);
